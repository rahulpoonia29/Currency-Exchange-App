...
function CurrencyRates({ currencyData, currencies, currencyNames }) {
    ...
    return (
        <div className="w-[90%] max-h-[95%] mb-5 lg:w-[50%] lg:mb-0 overflow-y-scroll no-scrollbar bg-white p-4 rounded-xl bg-opacity-20 backdrop-filter backdrop-blur-lg">
